...
public class Tela_Cadastrar_Pergunta extends JFrame {
	...
	public Tela_Cadastrar_Pergunta() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (acao) {
					...
					if (pergunta.Cadastrar(true).equals("OK") && comboBox.getSelectedIndex() != 0) {
						...
						JOptionPane.showMessageDialog(null, "Um ou mais campo não foram preenchidos");
					}
				} else {
					try {
		...
		if (listaObjectPerg.size() != 0) {
			...
			comboBoxEditar.setModel(new DefaultComboBoxModel(new Categoria().listaCategoria()));
			txtEditarPergunta.setText("Não há perguntas cadastradas");
			txtEditarCorreta.setText("Não há perguntas cadastradas");
			txtEditarIncorreta1.setText("Não há perguntas cadastradas");
			txtEditarIncorreta2.setText("Não há perguntas cadastradas");
			txtEditarIncorreta3.setText("Não há perguntas cadastradas");
		}
		btnSalvar.setVisible(false);
		btnCancelar.setVisible(false);
